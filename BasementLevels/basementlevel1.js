...
var press = new Audio("../Button Press Sound Effect.mp3");
var pressed = false;
...
button.addEventListener("click", function(){
    press.play();
    pressed = true;
    objective.innerHTML = "Get to the escape. It's quite tricky to find, however."
...
function move(e){
    if(e.keyCode == 39 || e.keyCode == 68){
        ...
        if(elementsOverlap(cart, gate1)){
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "Nice try but no.";
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
        ...
        if(elementsOverlap(cart, gate3)){
            // ow.play();
            window.location.href = "Basement Level 2.html";
    ...
    if(e.keyCode == 37 || e.keyCode == 65){
        ...
        if(elementsOverlap(cart, gate1)){
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "Door's closed";
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
        ...
        if(elementsOverlap(cart, gate2)){
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "It's shut";
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
    ...
    if(e.keyCode == 38 || e.keyCode == 87){
        ...
        if(elementsOverlap(cart, gate1)){
            // ow.play();
            falsealarm.innerHTML = "Try again";
            console.log("...");
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
        ...
        if(elementsOverlap(cart, gate2)){
            // ow.play();
            falsealarm.innerHTML = "Door is closed.";
            console.log("...");
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
    ...
    if(e.keyCode == 40 || e.keyCode == 83){
        ...
        if(elementsOverlap(cart, gate1)){
            ...
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "Door must be broken";
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
        ...
        if(elementsOverlap(cart, gate2)){
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "Find a working exit.";
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
