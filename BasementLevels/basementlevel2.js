...
function move(e){
    if(e.keyCode == 39 || e.keyCode == 68){
        ...
        if(elementsOverlap(cart, gate1)){
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "That's not an open one."
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
        ...
        if(elementsOverlap(cart, gate2)){
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "Not quite."
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
        ...
        if(elementsOverlap(cart, gate3)){
            // ow.play();
            window.location.href = "Basement Level 3.html";
    ...
    if(e.keyCode == 37 || e.keyCode == 65){
        ...
        if(elementsOverlap(cart, gate1)){
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "Unfortunately, that's closed."
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
    ...
    if(e.keyCode == 38 || e.keyCode == 87){
        ...
        if(elementsOverlap(cart, gate1)){
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "Exit is jammed."
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
        ...
        if(elementsOverlap(cart, gate2)){
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "Door's jammed."
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
    ...
    if(e.keyCode == 40 || e.keyCode == 83){
        ...
        if(elementsOverlap(cart, gate1)){
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "Closed exit."
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
        ...
        if(elementsOverlap(cart, gate2)){
            // ow.play();
            console.log("...");
            falsealarm.innerHTML = "Probably not a door at all."
            document.getElementById("cart").style.left = "620px";
            document.getElementById("cart").style.top = "450px";
            hit.play();
            lives--;
