...
function move(e){
    if(e.keyCode == 39 || e.keyCode == 68){
        ...
        if(elementsOverlap(cart, book1)){
            console.log("retrieved");
            book1.style.display = "none";
            items++;
        }
        if(elementsOverlap(cart, book2)){
            console.log("retrieved");
            book2.style.display = "none";
            items++;
        }
        if(elementsOverlap(cart, book3)){
            console.log("retrieved");
            book3.style.display = "none";
            items++;
        }
        if(elementsOverlap(cart, book4)){
            console.log("retrieved");
            book4.style.display = "none";
            items++;
        }
        if(elementsOverlap(cart, book5)){
            console.log("retrieved");
        ...
        if(elementsOverlap(cart, finish) && items == 5){
            window.location.href = "Library Level 2.html";
        }
