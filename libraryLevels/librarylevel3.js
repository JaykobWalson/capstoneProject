...
var plank3 = document.getElementById("plank3");


var lives = 3;
var items = 0;
var crash = new Audio("../woodsnap.mp3");
...
function move(e){
    if(e.keyCode == 39 || e.keyCode == 68){
        ...
        if(elementsOverlap(cart, plank1)){
                setTimeout(() => {  
                    crash.play();
                    }, 100);
                setTimeout(() => {  
                    window.location.href = "../BasementLevels/BasementIntro.html";
                    }, 400);
 
            
        }
        if(elementsOverlap(cart, plank2)){
            setTimeout(() => {  
                crash.play();
                }, 100);
            setTimeout(() => {  
        ...
        if(elementsOverlap(cart, plank3)){
            setTimeout(() => {  
                crash.play();
                }, 100);
            setTimeout(() => {  
